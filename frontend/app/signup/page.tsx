...
import { Sparkles, Mail, Lock, UserPlus, Loader2, ArrowRight } from "lucide-react";
        ...
        <div className="min-h-screen flex items-center justify-center bg-[#F9FAFB] text-slate-900 font-sans antialiased px-6">
            ...
            <div className="relative w-full max-w-md">
                ...
                <p className="text-center text-sm font-medium text-slate-500 mt-8">
                    ...
                    <Link href="/login" className="text-blue-600 hover:text-blue-700 hover:underline underline-offset-4 inline-flex items-center gap-1 transition-all">
